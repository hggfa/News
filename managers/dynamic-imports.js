        ...
        try {
            read.fileSync(folder).forEach(file => {
                ...
                try {
                    ...
                    return console.error(`Impossible de charger les modules à partir de ${folderName} (${path.relative(folder, file)})\n${e}`);
                }
            ...
            console.error(`Impossible de charger les modules à partir de ${folderName}\n${e}`);
        }
    }
