...
exports.run = (bot, msg, args) => {
    ...
    msg.channel.fetchMessages({ limit: Math.min(count, 100), before: msg.id }).then(messages => {
        ...
        if (attachments.length === 0) throw 'Impossible de trouver des images.';
...
exports.info = {
    ...
    description: 'Récupère toutes les images de la quantité spécifiée de messages (max 100)' // Liam Bagge#0550
};
